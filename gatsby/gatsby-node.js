...
async function fetchBeersAndTurnIntoNodes({
  ...
  for (const beer of beers) {
    ...
    // const nodeContent = JSON.stringify(beer); | don't need that
    // meta data about the node content
    const nodeMeta = {
...
export async function createPages(params) {
  ...
  // await them concurrently - wait for promises to be resolved b4 finishing this function
  await Promise.all([
